...
EVAL_EPISODES    = 20
SEED             = 42
MODEL_SAVE_PATH  = "results/models/a2c_LONG"
LOG_SAVE_PATH    = "results/logs/training/a2cLONG_training_log.json"
CURVE_SAVE_PATH  = "results/logs/training/a2cLONG_learning_curve.json"
